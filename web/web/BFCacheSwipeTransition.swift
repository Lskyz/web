            ...
            try {
                ...
                if (isVirtualScroll) {
                    ...
                    if (virtualIndexAnchors.length > 0) {
                        ...
                        scrollVirtualByIndex(index, targetY, function(indexSuccess) {
                            if (indexSuccess) {
                ...
                function continueAnchorMatching() {
                    // 앵커 데이터 확인
...
extension BFCacheTransitionSystem {
    ...
    // 🚀 **수정: JavaScript 앵커 캡처 스크립트 개선 (가상 스크롤 대응)** - 동일하게 유지
