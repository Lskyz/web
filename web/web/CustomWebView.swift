    ...
    class Coordinator: NSObject, WKUIDelegate, UIScrollViewDelegate, WKScriptMessageHandler, UIGestureRecognizerDelegate {
        ...
        @objc private func handleEdgeGesture(_ gesture: UIScreenEdgePanGestureRecognizer) {
            ...
            case .changed:
                ...
                updateSwipePreview(progress: progress, translation: translation, direction: direction)
        ...
        // MARK: - 스와이프 미리보기 업데이트
        private func updateSwipePreview(progress: CGFloat, translation: CGPoint, direction: SwipeDirection) {
